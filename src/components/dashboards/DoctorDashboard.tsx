                  ...
                  <div className="bg-white rounded-3xl max-w-lg w-full p-6 space-y-4 shadow-2xl border max-h-[85vh] overflow-y-auto">
                    ...
                    <div className="space-y-2 text-xs">
                      <div className="p-3 bg-slate-50 rounded-xl border">
                        <p><strong>কার্ড আইডি:</strong> {selectedPatient.cardId}</p>
                        <p><strong>রক্তের গ্রুপ:</strong> {selectedPatient.bloodGroup}</p>
                        <p><strong>ঠিকানা:</strong> {selectedPatient.address}, {selectedPatient.upazila}</p>
                      </div>
