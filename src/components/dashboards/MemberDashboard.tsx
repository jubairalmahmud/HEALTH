                ...
                <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-slate-300 flex items-center gap-2">
                      <span>কার্ড আইডি: <strong className="text-amber-300 font-mono">{card?.cardId}</strong></span>
                      <span>•</span>
                      <span>হেলথ আইডি: <strong className="text-sky-300 font-mono">{card?.memberId}</strong></span>
                    </p>
                    <div className="flex flex-wrap items-center gap-3 text-xs pt-1">
                      <span className="bg-slate-800 px-2.5 py-1 rounded-lg border border-slate-700 text-slate-300">
                        টাইপ: <strong className="text-emerald-400">{card?.cardTier}</strong>
                      </span>
                      <span className="bg-slate-800 px-2.5 py-1 rounded-lg border border-slate-700 text-slate-300">
                        মেয়াদ: <strong className="text-amber-300">{card?.expiryDate}</strong>
                      </span>
                      <span className="bg-slate-800 px-2.5 py-1 rounded-lg border border-slate-700 text-slate-300">
                        রক্তের গ্রুপ: <strong className="text-rose-400">{card?.bloodGroup}</strong>
                      </span>
                      <button
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-6">
              ...
              {card.status === 'PENDING' ? (
                ...
                <div className="flex justify-center">
                  <MedicalCardPrint card={card} showPrintButton={true} />
                </div>
              )}
            </div>
          )}
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-4">
              <div className="border-b border-slate-100 pb-3">
                <h3 className="font-extrabold text-base text-slate-900 flex items-center gap-2">
                  ...
                  আমার মেডিকেল ও প্যাথলজি রিপোর্ট
                </h3>
              ...
              {reports.length === 0 ? (
                <div className="p-8 text-center bg-slate-50 rounded-2xl border border-dashed border-slate-200 space-y-2">
                  ...
                  <p className="text-xs font-bold text-slate-700">কোনো ডিজিটাল রিপোর্ট পাওয়া যায়নি</p>
                  ...
                  {reports.map(r => (
                    <div key={r.id} className="p-4 rounded-2xl border border-slate-200 bg-slate-50 space-y-3">
                      <div className="flex items-start justify-between">
                        <div>
                          <span className="inline-block bg-emerald-100 text-emerald-800 font-extrabold text-[10px] px-2 py-0.5 rounded mb-1">
                            {r.status}
                          </span>
                      ...
                      >
                        <Eye className="w-3.5 h-3.5" /> বিস্তারিত বিবরণ দেখুন
                      </button>
                    </div>
                  ))}
                </div>
                ...
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                  <div className="bg-white rounded-3xl max-w-lg w-full p-6 space-y-4 shadow-2xl border border-slate-200">
                    ...
                    <div className="space-y-2 text-xs text-slate-700">
                      ...
                      <p><strong>ডায়াগনস্টিক সেন্টার:</strong> {selectedReport.centerName}</p>
                      <p><strong>তারিখ:</strong> {selectedReport.reportDate}</p>
                      ...
                      <div className="p-3 bg-slate-50 rounded-xl border text-slate-800 font-mono">
                        <strong className="block text-slate-900">ফলাফল বিস্তারিত:</strong>
              ...
              <div className="border-b border-slate-100 pb-3 flex items-center justify-between">
                <div>
                  <h3 className="font-extrabold text-base text-slate-900 flex items-center gap-2">
                    ...
                    পরিবারের নিবন্ধিত সদস্যবৃন্দ (Beneficiaries)
                  </h3>
