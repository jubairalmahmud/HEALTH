              ...
              <div className="w-full max-w-sm rounded-2xl bg-white/10 backdrop-blur-xl p-6 border border-white/20 shadow-2xl text-white space-y-5">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-1 text-xs">
                    <p className="font-bold text-sm text-white">রহিম উদ্দিন শেখ</p>
                    <p className="text-sky-200 font-mono">ID: DMB-2026-1001</p>
                    <p className="text-[11px] text-emerald-300 font-medium">রক্তের গ্রুপ: B+ (Positive)</p>
                    <p className="text-[10px] text-sky-300">ঠিকানা: বেডগ্রাম, গোপালগঞ্জ সদর</p>
                  </div>
                </div>
