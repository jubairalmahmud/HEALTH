...
import { Search, ShieldCheck, QrCode, AlertCircle, CheckCircle2, XCircle, Printer, RefreshCw, User, Phone, CreditCard, FileText, Check } from 'lucide-react';
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          {errorMsg ? (
            ...
            <div className="space-y-6 animate-fadeIn">
                ...
                <div className="bg-sky-50 border border-sky-200 rounded-2xl p-4 space-y-3">
                  <div className="flex items-center justify-between">
                    <h4 className="font-extrabold text-sky-900 text-xs sm:text-sm flex items-center gap-1.5">
                      ...
                      অনুসন্ধানে মোট {matchedCards.length} টি সম্ভাব্য সদস্যের কার্ড পাওয়া গেছে।
                    </h4>
                    <span className="text-[10px] text-sky-700 font-medium">যেকোনো কার্ডে ক্লিক করে বিবরণ দেখুন</span>
                  </div>
                    ...
                    {matchedCards.map(c => (
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-[10px] text-slate-500 truncate">ফোন: {c.mobile} | NID: {c.nidOrBirthCert}</p>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              {cardResult && (
                <div className="bg-white rounded-3xl p-6 border border-emerald-200 shadow-xl space-y-6">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-extrabold text-emerald-900 text-base">
                          কার্ডটি সম্পূর্ণ বৈধ ও নিবন্ধিত (VERIFIED VALID CARD)
                        </h3>
                        <p className="text-xs text-emerald-700">
                          ডিজিটাল মিডিয়া ব্রিজ হেলথ নেটওয়ার্ক ভেরিফাইড জাতীয় সদস্য।
                        </p>
                      </div>
                    </div>
                    <span className="px-3.5 py-1.5 rounded-full bg-emerald-600 text-white font-black text-xs font-mono self-start sm:self-auto">
                      ✓ {cardResult.status}
                    </span>
                  </div>

                  {/* Printable Medical Card Component */}
                  <MedicalCardPrint card={cardResult} showPrintButton={true} />
